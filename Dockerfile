...
RUN wget https://raw.githubusercontent.com/JustBeta/sonicwall-privoxy/main/nxBender/nxBender.sh -O /nxBender.sh
RUN chmod u+x /nxBender.sh
RUN /nxBender.sh && rm /nxBender.sh

# Proxy Privoxy
#COPY privoxy/privoxy.sh /privoxy.sh
RUN wget https://raw.githubusercontent.com/JustBeta/sonicwall-privoxy/main/privoxy/privoxy.sh -O /privoxy.sh
...
RUN wget https://raw.githubusercontent.com/JustBeta/sonicwall-privoxy/main/start.sh -O /usr/sbin/start.sh
